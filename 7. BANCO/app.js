...
function modificarDatos() {
    let nom = /^[A-Za-zñ]{3,20}$/;//El nombre debe contener entre 3 y 20 caracteres 
    let ape1 = /^[A-Za-zñ]{3,20}$/;//El primer apellido debe contener entre 3 y 20 caracteres 
    let ape2 = /^[A-Za-zñ]{3,20}$/; //El segundo apellido debe contener entre 3 y 20 caracteres 
    ...
    var nuevoNac= document.getElementById('nacionalidad').value;

    if (!nom.test(nuevoN) || !ape1.test(nuevoA1) || !ape2.test(nuevoA2) || !nac.test(nuevoNac)){
        ...
        // metemos los valores a persona
        persona.nombre = nuevoN;
        persona.apellido1 = nuevoA1;
        persona.apellido2 = nuevoA2;
        persona.nacionalidad = nuevoNac;
